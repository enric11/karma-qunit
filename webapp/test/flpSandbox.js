		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ecastellakarmaqunit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ecastellakarmaqunit-display": {
								"semanticObject": "ecastellakarmaqunit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ecastella.karmaqunit",
									"url": sap.ui.require.toUrl("ecastella/karmaqunit")
								}
							}
						}
					}
